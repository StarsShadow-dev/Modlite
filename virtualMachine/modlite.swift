...
//
                ...
                let number2 = UInt32(ModliteRunTime.stack.popLast()!)!
                let number1 = UInt32(ModliteRunTime.stack.popLast()!)!

				ModliteRunTime.stack.append(String(number1 / number2))
            }
//
...
//	print("utf8 \(UnicodeScalar(string)!.value)")
    return UInt32(UnicodeScalar(string)!.value)
}
